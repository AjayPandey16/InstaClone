    ...
    return (
        <>
            <div className='w-full min-h-screen flex flex-col justify-center items-center bg-black gap-6 px-4'>
                <form onSubmit={SubmitForm} className='flex w-full max-w-[350px] flex-col gap-4 bg-gray-900 p-6 rounded-lg shadow-lg'>
                    <img className='mx-auto w-[150px] object-cover' src={logo} alt='' />
